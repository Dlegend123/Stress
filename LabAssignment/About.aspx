<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="LabAssignment.About" %>
...
<div class="container h-100">
    ...
    <table class="table" style="color:whitesmoke">
        <tr>
            <th class="text-center" ><h1 style="color:whitesmoke">About Us</h1></th>
        </tr>
        </table>
